...
//    private fun upload(fileath: String){
//
//        val file = Uri.fromFile(File(fileath))
...
//    }
//
//    public fun download (reference: StorageReference,imageView: ImageView){
//
//
//        var mStorageRef =FirebaseStorage.getInstance().getReference();
//        var ref =mStorageRef.child("Pepe.png")
//
//        ref.downloadUrl.addOnSuccessListener {object : OnSuccessListener<Url>
//        {
